...
class EquALSSL(StrategySSL):
    def __init__(self, list_train_imgs, idxs_lb, idxs_unlb, net, net_D, args, writer):
        super(EquALSSL, self).__init__(list_train_imgs, idxs_lb, idxs_unlb, net, net_D, args, writer)
