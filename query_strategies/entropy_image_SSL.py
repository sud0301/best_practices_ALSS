...
class EntropyImageSSL(StrategySSL):
    def __init__(self, list_train_imgs, idxs_lb, idxs_unlb, net, net_D, args, writer):
        super(EntropyImageSSL, self).__init__(list_train_imgs, idxs_lb, idxs_unlb, net, net_D, args, writer)
    ...
    def sort_images_by_entropy(self):
        ...
        trainloader = data.DataLoader(train_dataset, batch_size=self.args.test_batch_size, sampler=train_sampler, num_workers=4, pin_memory=False)
